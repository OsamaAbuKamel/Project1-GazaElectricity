...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    Calendar calendar2 = new GregorianCalendar(2023, 10, 1);
    ...
    // System.out.println("Month 11: " + statistics.getStatisticForMonth(10, ElectricityType.ISRAELI_LINES, StatisticType.TOTAL));
